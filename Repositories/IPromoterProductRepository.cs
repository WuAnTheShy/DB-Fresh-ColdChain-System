...
public interface IPromoterProductRepository
{
    ...
    // 更新已入团（商品，供应商）组合的团长带货介绍文字（仅限 Active 记录）
